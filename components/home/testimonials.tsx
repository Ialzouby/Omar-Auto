  ...
  return (
    <section className="py-20 bg-secondary/30">
      <div className="container">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Real People, Real Problems</h2>
          <p className="text-lg text-muted-foreground">
            Hear from people who are excited about the future of autonomous driving with Omar.
          </p>
        </motion.div>
