        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            ...
            <p className="mb-4 text-secondary/80">
              Make any vehicle autonomous in 30 minutes. Saving lives, saving money.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/#product" className="text-secondary/80 hover:text-secondary transition-colors">
                  Product
                </Link>
              </li>
              <li>
                <Link href="/#benefits" className="text-secondary/80 hover:text-secondary transition-colors">
                  Benefits
                </Link>
              </li>
              <li>
                <Link href="/team" className="text-secondary/80 hover:text-secondary transition-colors">
                  Team
                </Link>
              </li>
              <li>
