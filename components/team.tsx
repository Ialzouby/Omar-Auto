  ...
  return (
    <section id="team" className="py-20">
      <div className="container">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Exceptional Team</h2>
          <p className="text-lg text-muted-foreground">
            Built by alumni of leading technology companies and institutions, our team brings decades of expertise in
            AI, engineering, and automotive technology.
          </p>
        </motion.div>
